                    ...
                    <ul class="side-nav magic-nav niv-class-animate">
                        ...
                        @else
                            <div class="clearfix " style="padding: 15px 15px 15px 15px">
                                <img src="{{URL::asset('assets/demo/users/'.Auth::user()->avatar)}}" alt="" class="" style="margin-left: 20%;border-radius: 50%;width: 70px;height: 70px;">
                                ...
                                <a href="{ { route('logout') }}"  style="padding-right: 100px;padding-left: 10px" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"
                                >
                                ...
                                <span style="padding-top:6px;font-size: 15px;text-align: center;display: block;color: white">DR . {{ Auth::user()->name }}</span>
                            </div>
                        ...
                        <li class="milestone menu_principale">
                            <a href="#">
                                Rendez vous du jour
